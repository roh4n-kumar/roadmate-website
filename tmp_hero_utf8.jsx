...
// ΓöÇΓöÇ Custom Calendar (no external dependency) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        <div className="search-inner-wrapper">
          ...
          <div className="glass-search-container">
            ...
            <div ref={dateRef} className="search-field" style={{ flex:1.8 }}>
              ...
              {/* ΓöÇΓöÇ Custom Calendar Popup ΓöÇΓöÇ */}
              {showCal && (
      ...
      <div className="how-section">
        <div className="how-inner">
          <div className="section-header">
            ...
            <p className="section-sub">Simple, fast, and completely online ΓÇö no paperwork, no hassle.</p>
          </div>
