          ...
          <div style={{ gridColumn: "span 2" }}>
            ...
            <div style={{ display: "flex", gap: "15px" }}>
              {["facebook", "twitter", "instagram", "linkedin"].map(social => (
                <div key={social} style={{ width: "40px", height: "40px", borderRadius: "12px", background: `${RED}15`, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.3s" }}>
                  {socialIcons[social]}
                </div>
              ))}
            </div>
