        ...
        <div ref={searchRef} style={{ position: 'relative', maxWidth: '1240px', margin: '0 auto' }}>
          <div className="search-main-card">
            ...
            <div className="search-col" onClick={() => openDropdown('cat')} 
              ...
              <div className={`col-label ${showCat ? 'active' : ''}`}>Vehicle Category <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ transform: showCat ? 'rotate(0deg)' : 'rotate(270deg)' }}><polyline points="6 9 12 15 18 9"/></svg></div>
            ...
            <div className="search-col" onClick={() => openDropdown('cal')} 
              ...
              <div className={`col-label ${showCal ? 'active' : ''}`}>Booking Date <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ transform: showCal ? 'rotate(0deg)' : 'rotate(270deg)' }}><polyline points="6 9 12 15 18 9"/></svg></div>
            ...
            <div className="search-col" onClick={() => openDropdown('pick')} 
              ...
              <div className={`col-label ${showPickTime ? 'active' : ''}`}>Pickup Time <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ transform: showPickTime ? 'rotate(0deg)' : 'rotate(270deg)' }}><polyline points="6 9 12 15 18 9"/></svg></div>
              <div className="col-value" style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#1a202c' }}>
                <svg width="42" height="42" viewBox="0 0 24 24" fill={RED}>
            ...
            <div className="search-col" onClick={() => openDropdown('drop')} 
              ...
              <div className={`col-label ${showDropTime ? 'active' : ''}`}>Dropoff Time <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ transform: showDropTime ? 'rotate(0deg)' : 'rotate(270deg)' }}><polyline points="6 9 12 15 18 9"/></svg></div>
              <div className="col-value" style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#1a202c' }}>
                <svg width="42" height="42" viewBox="0 0 24 24" fill={RED}>
                  <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/>
                </svg>
