...
const Hero = ({ isDrawerOpen, setIsDrawerOpen }) => {
  ...
  const [formData, setFormData] = useState(() => {
    ...
    return {
      ...
      withHelmet: true,
      helmetCount: 0, // 0 means not yet selected
      withDriver: false,
      selectedDate: d,
  ...
  const IconVerified = () => (
    <div style={{ width: 60, height: 60, borderRadius: "50%", background: "#fdf2f2", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <svg width="32" height="32" viewBox="0 0 960 960" fill="none">
        ...
        <path d="M62.4105 376.051C79.5025 382.753 118.711 410.297 110.585 431.36C93.2885 465.448 61.5485 423.425 44.8315 409.278C33.8425 397.126 46.4635 376.762 62.4105 376.051Z" fill={RED}></path>
  ...
  const css = `
    ...
    @media (max-width: 900px) {
      .hero-section { margin-top: 0 !important; padding-bottom: 10px; background: #fdfdfd !important; }
      .search-ribbon-v2 { 
              ...
              {showCat && (
                <div className="cal-box" style={{ padding: "8px", width: "240px" }}>
                  {[
                    ...
                    return (
                      <div key={opt.label}
                        onClick={(e) => { e.stopPropagation(); setFormData({...formData, vehicleType: opt.type, withHelmet: opt.helmet, withDriver: opt.driver, helmetCount: 0}); openDropdown('off'); }}
                        style={{ 
