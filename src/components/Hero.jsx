              ...
              <div className="col-value" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#1a202c' }}>
                   {formData.vehicleType === 'Bike' ? 
                    <svg width="28" height="28" viewBox="0 0 122.88 82.71" fill={RED}>
                    ...
                    <svg width="28" height="28" viewBox="0 0 122.88 92.02" fill={RED}>
        ...
        <div className="info-ribbon-bar">
          ...
          <div className="info-item">
            <span className="info-icon">
              <svg width="24" height="24" viewBox="0 0 960 960" fill="none">
