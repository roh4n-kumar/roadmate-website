          ...
          {offers.map((off) => (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ margin: "2px 0 10px", fontSize: "11px", color: "rgba(255,255,255,0.85)", fontWeight: 500, lineHeight: "1.25" }}>{off.desc}</p>
                <div style={{ display: "inline-block", padding: "6px 14px", borderRadius: "7px", background: "#ffffff", fontWeight: 900, color: off.color, fontSize: "11px", letterSpacing: "1.5px", boxShadow: "0 3px 8px rgba(0,0,0,0.08)" }}>
                  {off.code}
                </div>
              </div>
            </motion.div>
