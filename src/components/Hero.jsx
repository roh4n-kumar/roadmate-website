...
const Hero = ({ isDrawerOpen, setIsDrawerOpen }) => {
  ...
  const css = `
    ...
    .search-col:hover .col-label,
    .search-col:hover .col-value,
    .search-col:hover .col-sub,
    .search-col:hover svg {
      color: #fff !important;
      stroke: #fff !important;
    }
    .search-col:hover .col-value svg {
      fill: #fff !important;
        ...
        <div ref={searchRef} style={{ position: 'relative', maxWidth: '1240px', margin: '0 auto' }}>
          <div className="search-main-card">
            ...
            <div className="search-col" onClick={() => openDropdown('cat')} 
              style={{ zIndex: showCat ? 50 : 1, background: showCat ? RED : 'transparent' }}>
              <div className="col-label" style={{ color: showCat ? '#fff' : '#718096' }}>Vehicle Category <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="6 9 12 15 18 9"/></svg></div>
              <div className="col-value" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: showCat ? '#fff' : '#1a202c' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  {formData.vehicleType === 'Bike' ? 
                    <svg width="24" height="24" viewBox="0 0 122.88 82.71" fill={showCat ? '#fff' : RED}>
                    ...
                    <svg width="24" height="24" viewBox="0 0 122.88 92.02" fill={showCat ? '#fff' : RED}>
                  ...
                  <span style={{ fontSize: '32px', fontWeight: 700, fontFamily: H, color: showCat ? '#fff' : '#111', lineHeight: 1 }}>
                    {formData.vehicleType}
                  </span>
                </div>
              </div>
              <div className="col-sub" style={{ color: showCat ? '#fff' : '#718096' }}>
            ...
            <div className="search-col" onClick={() => openDropdown('cal')} 
              style={{ zIndex: showCal ? 50 : 1, background: showCal ? RED : 'transparent' }}>
              <div className="col-label" style={{ color: showCal ? '#fff' : '#718096' }}>Booking Date <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="6 9 12 15 18 9"/></svg></div>
              <div className="col-value" style={{ color: showCal ? '#fff' : '#1a202c' }}>{formData.dateDisplay}</div>
              <div className="col-sub" style={{ color: showCal ? '#fff' : '#718096' }}>{formData.dayName}</div>
              {showCal && (
            ...
            <div className="search-col" onClick={() => openDropdown('pick')} 
              style={{ zIndex: showPickTime ? 50 : 1, background: showPickTime ? RED : 'transparent' }}>
              <div className="col-label" style={{ color: showPickTime ? '#fff' : '#718096' }}>Pickup Time <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="6 9 12 15 18 9"/></svg></div>
              <div className="col-value" style={{ color: showPickTime ? '#fff' : '#1a202c' }}>{formData.pickupTime}</div>
              <div className="col-sub" style={{ color: showPickTime ? '#fff' : '#718096' }}>Select start time</div>
              {showPickTime && (
            ...
            <div className="search-col" onClick={() => openDropdown('drop')} 
              style={{ zIndex: showDropTime ? 50 : 1, background: showDropTime ? RED : 'transparent' }}>
              <div className="col-label" style={{ color: showDropTime ? '#fff' : '#718096' }}>Dropoff Time <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="6 9 12 15 18 9"/></svg></div>
              <div className="col-value" style={{ color: showDropTime ? '#fff' : '#1a202c' }}>{formData.dropoffTime}</div>
              <div className="col-sub" style={{ color: showDropTime ? '#fff' : '#718096' }}>Select end time</div>
              {showDropTime && (
                <div className="cal-box" style={{ padding: 0, width: "240px" }} onClick={e => e.stopPropagation()}>
