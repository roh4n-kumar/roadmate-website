...
const DocumentVerification = () => {
  ...
  return (
    <div className="pi-page-wrapper" style={{ minHeight:"100vh", background:"#f5f7f9", fontFamily:F }}>
      <style>{`
            ...
            <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} className="pi-card">
              ...
              <div>
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                  ...
                  {docStatus.aadhaar === "verified" && <div style={{ color:"#10b981" }}><CheckIcon /></div>}
                </div>
              ...
              <div>
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                  ...
                  {docStatus.selfie === "verified" && <div style={{ color:"#10b981" }}><CheckIcon /></div>}
                </div>
