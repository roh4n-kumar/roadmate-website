                                        ...
                                        renderIcon: () => (
                                            <svg width="48" height="36" viewBox="-2 -2 126.88 86.71" fill="none">
                                                <g fillRule="evenodd" clipRule="evenodd">
                                                    {/* Full High-Detail Silhouette - Slate */}
                                                    ...
                                                    {/* Motorcycle Seat - Red (Precise Silhouette Path) */}
                                                    ...
                                                    {/* Central Engine Detail (Middle) - Red */}
                                                    <path fill={RED} d="M54,42h18v4h-18z M56,48h14v2h-14z" opacity="0.8" />
                                                    {/* Wheels - Red Inner Rims (Precise Alignment) */}
                                                    <circle cx="104.65" cy="64.49" r="14.5" fill={RED} />
                                                    <ellipse cx="18.15" cy="69.88" rx="10.5" ry="10.3" fill={RED} />
                                                    {/* Tank Accent Overlay - Red */}
