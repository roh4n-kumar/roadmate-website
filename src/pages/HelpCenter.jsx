                            ...
                            <div>
                                ...
                                {[
                                    ...
                                    { 
                                        name: "Bike FAQ", 
                                        renderIcon: () => (
                                            <svg width="42" height="32" viewBox="0 0 122.88 82.71" fill="none">
                                                <g fillRule="evenodd" clipRule="evenodd">
                                                    {/* Mechanical Parts, Wheels, Engine - Slate */}
