            ...
            <div style={{ flex: 1, background: "#ffffff", display: "flex", alignItems: "center", justifyContent: "center", padding: "50px 20px 80px" }}>
                <div style={{ maxWidth: "1200px", width: "100%", display: "flex", flexWrap: "wrap", gap: "60px", alignItems: "stretch", justifyContent: "center" }}>
                    ...
                    >
                        ...
                        <div style={{ flex: 1, position: "relative", display: "flex", flexDirection: "column", minHeight: "450px" }}>
                            <AnimatePresence>
                                {!activeCategory ? (
                                    <motion.div 
                                        key="dashboard"
                                    ...
                                    >
                                        ...
                                        {Object.keys(faqData).map((catName, i) => (
                                            <div 
                                                key={i} 
                                            ...
                                            >
                                                <div style={{ marginBottom: "12px", display: "flex", justifyContent: "center" }}>
                                                    {i === 0 && <svg width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M6 10l1.5-4h9L18 10" stroke={RED} strokeWidth="1.5" /><path d="M3 10h18v5H3z" fill={RED} /></svg>}
                                                    {i === 1 && <svg width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M12 2L2 7l10 5 10-5-10-5z" fill={RED} /></svg>}
                                                    {i === 2 && <svg width="42" height="22" viewBox="0 0 512 265" fill="none"><path d="M0 0h512v265H0z" fill={RED} /></svg>}
                                                </div>
                                                <span style={{ fontSize: "14px", fontWeight: 800, color: SLATE, fontFamily: H }}>{catName}</span>
                                            </div>
                                        ))}
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        <div style={{ display: "flex", alignItems: "center", gap: "16px", padding: "20px 0", borderBottom: "1px solid rgba(0,0,0,0.08)", marginBottom: "8px" }}>
                                            <div onClick={() => setActiveCategory(null)} style={{ cursor: "pointer" }}>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={SLATE} strokeWidth="3"><path d="M19 12H5"/><path d="M12 19l-7-7 7-7"/></svg>
                                            </div>
                                        ...
                                        <div style={{ flex: 1, overflowY: "auto", paddingBottom: "20px" }}>
                                            {(faqData[activeCategory] || []).map((faq, idx) => (
                                                <div key={idx} style={{ padding: "20px 0", borderBottom: "1px solid rgba(0,0,0,0.05)" }}>
                                                    <p style={{ margin: "0 0 6px", fontSize: "15px", fontWeight: 700, color: SLATE, fontFamily: H }}>{faq.q}</p>
                                                    <p style={{ margin: 0, fontSize: "13.5px", color: "rgba(15,23,42,0.6)" }}>{faq.a}</p>
                                                </div>
                                            ))}
                                        </div>
                                    </motion.div>
