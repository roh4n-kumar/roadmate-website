                                        ...
                                        renderIcon: () => (
                                            <svg width="48" height="36" viewBox="-2 -2 126.88 86.71" fill="none">
                                                <g fillRule="evenodd" clipRule="evenodd">
                                                    ...
                                                    {/* Chassis & Engine Fill (Middle) - Red */}
                                                    <path fill={RED} d="M38,44h47l2,18H34l2-8z" />
                                                    {/* Wheels - Red Overlay (Precise Alignment) */}
                                                    <circle cx="104.65" cy="64.49" r="18.23" fill={RED} />
                                                    <ellipse cx="18.1" cy="69.8" rx="13.1" ry="12.9" fill={RED} />
